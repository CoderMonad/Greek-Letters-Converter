...
#define __VERSION_HEADER__
	...
	#define DEFINED_VER_REVISION  12

	//Miscellaneous Version Types
	#define DEFINED_VER_BUILDS_COUNT  27
	#define DEFINED_VER_RC_FILEVERSION 1,0,4,12
	#define DEFINED_VER_RC_FILEVERSION_STRING "1, 0, 4, 12\0"
	#define DEFINED_VER_FULLVERSION_STRING  "1.0.4.12"

	//These values are to keep track of your versioning state, don't modify them.
	#define DEFINED_VER_BUILD_HISTORY  13
