...
#define __VERSION_HEADER__
	...
	#define DEFINED_VER_REVISION  7
	
	//Miscellaneous Version Types
	#define DEFINED_VER_BUILDS_COUNT  3
	#define DEFINED_VER_RC_FILEVERSION 1,0,2,7
	#define DEFINED_VER_RC_FILEVERSION_STRING "1, 0, 2, 7\0"
	#define DEFINED_VER_FULLVERSION_STRING  "1.0.2.7"
